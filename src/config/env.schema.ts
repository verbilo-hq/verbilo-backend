...
export const EnvSchema = z
  .object({
    ...
    // Route 53 tenant DNS automation. When unset, prod tenant DNS provisioning
    // is skipped; staging is skipped separately because it is NS-delegated.
    R53_HOSTED_ZONE_ID: z.string().min(1).optional(),
